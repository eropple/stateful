...
namespace Ed.Stateful.ControlFlow
{
    public class StateSystem
    {
        ...
        protected virtual void ControllerButtonReleased(PlayerIndex index, Buttons button)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerButtonPressed(PlayerIndex index, Buttons button)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerRightTriggerMoved(PlayerIndex index, float delta, float newPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerLeftTriggerMoved(PlayerIndex index, float delta, float newPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerRightThumbstickMoved(PlayerIndex index, Vector2 delta, Vector2 newPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerLeftThumbstickMoved(PlayerIndex index, Vector2 delta, Vector2 newPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerDisconnected(PlayerIndex index)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void ControllerConnected(PlayerIndex index)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void MouseButtonReleased(MouseButtons button, Point currentPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void MouseButtonPressed(MouseButtons button, Point currentPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void MouseScrollWheelMoved(int delta)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void MouseMoved(Point delta, Point newPosition)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void KeyReleased(Keys key, bool ctrl, bool alt, bool shift)
        {
            if (States.Count == 0)
                return;
        ...
        protected virtual void KeyPressed(Keys key, bool ctrl, bool alt, bool shift)
        {
            if (States.Count == 0)
                return;
